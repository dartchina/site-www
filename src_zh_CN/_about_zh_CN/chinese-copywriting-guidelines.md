---
title: "中文排版指北"
description: "Dart 编程语言中文版中文排版指北"
---

本文来自 [LCTT 修订后的中文文案排版指北](https://github.com/LCTT/wiki/blob/master/tutorials/copywriting.md)，根据 DartChina 使用场景有修订。
文章最初来自：[中文文案排版指北](https://github.com/sparanoid/chinese-copywriting-guidelines/blob/master/README.zh-CN.md)。
